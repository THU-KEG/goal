...
class COCO:
    def __init__(self, annotation_file=None, annotation_js=None):
        """
        Constructor of Microsoft COCO helper class for reading and visualizing annotations.
        :param annotation_file (str): location of annotation file
        :param annotation_js (Json): Json object of annotation data
        ...
        if not annotation_file == None:
            ...
            self.createIndex()
        elif isinstance(annotation_js, (type(json), dict)):
            print('loading COCO annotations into memory...')
            self.dataset = annotation_js
            self.createIndex()
    ...
    def loadRes(self, resFile):
        ...
        :param   resFile (str)     : file name of result file or result Json object of COOC format
        ...
        elif isinstance(resFile, (type(json), dict)):
            anns = resFile['annotations']
        else:
            raise BaseException("Invalid parameter format.")
